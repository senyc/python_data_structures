...
from linear_probing_hash_map import MyHash
from linear_probing_hash_map import Item
...
class TestMyHash(unittest.TestCase):
    ...
    def test_filling_then_removal(self):
        my_hash = MyHash(2)

        my_hash.insert(12, 'frank12')
        my_hash.insert(11, 'frank11')
        self.assertEqual(len(my_hash), 2)
        my_hash.remove(11)
        self.assertEqual(len(my_hash), 1)
        my_hash.insert(11, 'frank11')
        self.assertEqual(len(my_hash), 2)
        self.assertEqual(my_hash[11], 'frank11')
